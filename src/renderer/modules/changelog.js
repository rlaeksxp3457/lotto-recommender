const CHANGELOG = [
  {
    version: "3.1.5", date: "2026-03-28", changes: [
      "연금복권 당첨 확인 로직 수정 (끝자리 기준, 동행복권 공식 규칙)",
      "연금복권 보너스 번호 당첨 확인 추가",
      "연금복권 당첨금 표시 (연금/일시불 형태)",
      "당첨 확인 카드에 '다시 확인' 버튼 추가",
    ],
  },
  {
    version: "3.1.4", date: "2026-03-11", changes: [
      "내 번호 용지 복사 버튼 추가",
      "10게임 저장 시 용지 5개 단위 자동 분할",
      "데이터 업데이트 NEW 뱃지 표시 버그 수정",
    ],
  },
  {
