  ...
  steps: [
    {
      ...
      desc: "1213회차 이상의 역대 당첨번호를 분석하여 7가지 알고리즘으로 번호를 추천합니다. 주요 기능을 안내해 드릴게요.",
      target: null,
    },
    {
      title: "BEST 5 추천",
      desc: "백테스트 성능 상위 5개 알고리즘에서 각 1게임씩, 총 5게임을 로또 용지 형태로 추천합니다.",
      target: "#btn-top5",
    },
    {
      title: "알고리즘별 번호 추천",
      desc: "7가지 통계 알고리즘(빈도, 핫/콜드, 오래된 번호, 쌍 기반, 홀짝 균형, 앙상블, 마르코프 체인)으로 번호를 추천합니다.",
